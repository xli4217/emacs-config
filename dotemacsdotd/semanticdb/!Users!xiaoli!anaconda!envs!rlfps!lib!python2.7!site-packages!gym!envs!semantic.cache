                  ...
                  ( ("__init__" function
                    ...
                    ("all" function
                       (:parent "dummy"
                        ...
                        (reparse-symbol indented_block_body) [3810 3864])
                    ("spec" function
                       (:parent "dummy"
                        :arguments 
                          ( ("self" variable nil (reparse-symbol function_parameters) [3878 3882])
                            ("id" variable nil (reparse-symbol function_parameters) [3884 3886]))                          )
                        (reparse-symbol indented_block_body) [3869 4819])
                    ("register" function
                       (:parent "dummy"
                        :arguments 
                          ( ("self" variable nil (reparse-symbol function_parameters) [4837 4841])
                            ("id" variable nil (reparse-symbol function_parameters) [4843 4845])
                            ("kwargs" variable nil (reparse-symbol function_parameters) [4847 4855]))                          )
                        (reparse-symbol indented_block_body) [4824 5012]))                  
                :type "class")
                nil [3290 5012])
            ("registry" variable nil nil [5038 5062])
            ("register" function (:arguments 
              ( ("id" variable nil (reparse-symbol function_parameters) [5077 5079])
                ("kwargs" variable nil (reparse-symbol function_parameters) [5081 5089]))              ) nil [5064 5135])
            ("make" function (:arguments 
              ( ("id" variable nil (reparse-symbol function_parameters) [5145 5147]))              ) nil [5136 5179])
            ("spec" function (:arguments 
              ( ("id" variable nil (reparse-symbol function_parameters) [5189 5191]))              ) nil [5180 5223]))          
      :file "registration.py"
      :pointmax 5223
      :fsize 5222
      :lastmodtime '(22598 10482 0 0)
      :unmatched-syntax '((NAME 2704 . 2708) (IF 2722 . 2724) (ELSE 2740 . 2744))))
  :file "!Users!xiaoli!anaconda!envs!rlfps!lib!python2.7!site-packages!gym!envs!semantic.cache"
